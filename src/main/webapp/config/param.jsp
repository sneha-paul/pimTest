    ...
    <c:otherwise>
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <form method="post" action="/pim/configs/{configId}/params" data-method="POST" data-success-message='["Successfully created the parameter", "Parameter Created"]' data-error-message='["Correct the validation error and try again", "Invalid Data"]' >
                    <div class="row">
