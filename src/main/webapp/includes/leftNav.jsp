...
<div class="p-l-0 p-r-0">
    <nav class="sidebar-nav">
        <ul class="main-menu metismenu">
            ...
            <li <c:if test="${active eq 'PRODUCT_FAMILIES'}">class="active"</c:if>><a href="/pim/productFamilies"><i class="icon-list"></i>Product Families</a></li>
            <li <c:if test="${active eq 'PRODUCT_VARIANTS'}">class="active"</c:if>><a href="/pim/productVariants"><i class="icon-list"></i>Product Variants</a></li>
