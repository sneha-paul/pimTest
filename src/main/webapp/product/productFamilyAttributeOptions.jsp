                        ...
                        <form method="post" action="/pim/productFamilies/{productFamilyId}/${entityType}/attributes/${attributeId}/options" data-method="PUT"
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <button type="button" class="btn btn-success" onclick="$.submitAction(event, this, function(){$.reloadDataTable('productAttributeOptions');$.resetAddUI();})"><i class="fa fa-plus"></i></button>
