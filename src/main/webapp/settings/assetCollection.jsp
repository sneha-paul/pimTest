...
<c:choose>
    <c:when test="${mode eq 'DETAILS'}">
        <tiles:insertDefinition name="mainLayout">
            <tiles:putAttribute name="title" value="PIM - Settings - Asset Collections"/>
    ...
    <c:otherwise>
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="body">
                        <form method="post" action="/pim/assetCollections" data-method="POST" data-success-message='["Successfully created the asset collection", "Collection Created"]' data-error-message='["Correct the validation error and try again", "Invalid Data"]' >
                            <div class="row">
