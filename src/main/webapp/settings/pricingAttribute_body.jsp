                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="js-dateRange">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control dateUI js-start" name="activeFrom" value="${pricingAttribute.activeFrom}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Active To </label>
                                                            <input type="text" class="form-control dateUI js-end" name="activeTo" value="${pricingAttribute.activeTo}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
