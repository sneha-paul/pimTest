...
<%--@elvariable id="parentAttribute" type="com.bigname.pim.core.domain.FamilyAttribute"--%>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="details">
                        <div class="row clearfix m-t-20">
                            <div class="col-lg-12 col-md-12">
                                <form method="post" action="/pim/families/{familyId}/attributes/{attributeId}" data-method="PUT"
                                      data-success-message='["Successfully updated the attribute", "Attribute Updated"]'
                                      data-error-message='["Correct the validation error and try again", "Invalid Data"]'>
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label>Attribute Collection</label>
                                                <input type="text" disabled="disabled" value="${attribute.collectionId}" class="form-control"/>
                                            </div>
                                            <div class="form-group">
                                                <label>Attribute Group</label>
                                                <input type="text" disabled="disabled" value="${attributeGroup}" class="form-control"/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select disabled="disabled" class="form-control" id="uiType" name="uiType">
                                ...
                                <div class="row p-b-25">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="pull-right">
                                            <button type="button" class="btn btn-success js-add-attributeOption"><i class="fa fa-plus"></i> <span class="p-l-5">Add Option</span></button>
                                        </div>
                                    </div>
                                </div>
