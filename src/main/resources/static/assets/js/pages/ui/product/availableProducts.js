$( document ).ready(function() {
    $.initGrid({
        ...
        columns: [
            { data: 'productName', name : 'productName' , title : 'Product Name', width:'80%', render: function ( data, type, row, meta ) {let imgUrl = row.imageName === 'noimage.png' ? '/assets/img/' + row.imageName : '/uploads/' + row.imageName;
