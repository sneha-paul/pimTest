...
public class Pagination  {
    ...
    /**
     * Checks if filter by is empty.
     *
     * @return true, if filter by is empty
     */
    public boolean hasFilters() {
        return filterBy != null && !filterBy.getFilters().isEmpty();
    }

    /**
     * Checks if sort by is empty.
     *
     * @return true, if sort by is empty
     */
    public boolean hasSorts() {
        return sortBy != null && !sortBy.getSorts().isEmpty();
    }
    ...
    /*public String getOrderByClause() {
        ...
        if(hasSorts()) {
            sortBy.getSorts().forEach((k,v) -> sb.append(sb.length() == 0 ? ORDER_BY : COMMA).append(k).append(SPACE).append(v));
        }
        return sb.toString();
    }*/
